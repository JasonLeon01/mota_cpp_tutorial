...
13.1. drawText(dx, dy, content, size, bond, Colour)
-------------------------------------------------------
...
13.2. drawText(rect, content, pos, size, bond, colour)
------------------------------------------------------
...
14.1. drawImage(file, x, y, opacity)
------------------------------------
...
14.2. drawImage(file, x, y, rect, opacity)
-------------------------------------------
